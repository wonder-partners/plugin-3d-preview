...
function normalizeStorageOptions(payload: any): StorageOption[] {
...
function normalizeStorageSettings(payload: any): EnvironmentMapStorageSettings | null {
...
function getDefaultStorageName(storages: StorageOption[]) {
